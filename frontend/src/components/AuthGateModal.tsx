    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-foreground/30 backdrop-blur-sm sm:items-center">
      <div className="w-full max-w-sm rounded-t-3xl bg-background p-6 shadow-xl sm:rounded-3xl">
        <div className="mb-4 flex items-center justify-between">
          <span className="text-sm font-medium text-foreground/60">Verify your number to continue</span>
          <button onClick={closeGate} className="rounded-full p-1 text-foreground/40 hover:bg-surface hover:text-foreground" aria-label="Close">
            <X size={18} />
          </button>
        </div>
        <OtpForm />
